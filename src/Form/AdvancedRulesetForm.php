...
class AdvancedRulesetForm extends EntityForm {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($triggering_element['#value']->getUntranslatedString() === 'Save') {
      ...
      /** @var  \Drupal\sms_advanced\Plugin\SmsRoutingRulePluginInterface $rule
       */
   ...
   *
   * @param \Drupal\sms_advanced\Plugin\SmsRoutingRulePluginCollection $rules
   ...
   *
   * @param \Drupal\sms_advanced\Plugin\SmsRoutingRulePluginInterface $rule
